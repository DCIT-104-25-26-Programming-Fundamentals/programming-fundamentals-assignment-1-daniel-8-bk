...
def add_task(tasks):
    """Prompts for a task description and appends it to the tasks list."""
...
def delete_task(tasks):
    """Prompts user for task number to delete and removes it if valid."""
    if not tasks:
...
def main():
    ...
    while True:
        ...
        print()  # Blank line between iterations for clean spacing
